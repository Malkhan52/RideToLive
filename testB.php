    ...
    <head>
        ...
        <style type="text/css">
            #LED_light{
                ...
                left: 620px;
                top: 48px;
                -webkit-animation-name: LED_light; /* Safari 4.0 - 8.0 */
              -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
              animation-name: LED_light;
        ...
        /* Safari 4.0 - 8.0 */
        @-webkit-keyframes LED_light {
          from {background-color: #343a40; opacity: 0.1}
        ...
        <div id="content">
            ...
            <div class="layout-tests landingPage">
                <section class="section--split">
                    ...
                    <div class="accordion">
                        <label for="commuter">
                            <h2 class="option">Commuter Test B</h2>
                        </label>
                                        ...
                                        <td class="results_container">
                                            ...
                                            <div class="button_wrapper">
                                                <form method="POST">
                                                    ...
                                                    <input type="hidden" name="alertType" id="alertType" value="light">
                                                    <input type="hidden" name="selectedLane" id="selectedChoice">
                                                <button class="try_again">TRY AGAIN</button>
                                                <button type="submit" name="submit" class="save_test">SAVE TEST</button>
                                                </form>
                                            </div>
                                        </td>
